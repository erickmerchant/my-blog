...
function Site(site_directory, nunjucks) {
...
Route.prototype.finish = function(pages) {
    ...
    if(route.template) {
        ...
        _.each(pages, function(page) {
            ...
            route.site.nunjucks.render(route.template, page, function(err, html) {
...
module.exports = function(site_directory, nunjucks) {

    return new Site(site_directory, nunjucks);
};
