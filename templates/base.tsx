	...
	return (
		<html lang="en-US">
			<head>
				...
				<title>
					{page_title ? page_title + " - " + site.title : site.title}
				</title>
				<link rel="preconnect" href="https://fonts.bunny.net" />
				<link rel="stylesheet" href="/page.css" />
				{styles ?? ""}
				<link
					href="https://fonts.bunny.net/css?family=jacquard-24:400|work-sans:200,400,600,800"
					rel="stylesheet"
				/>
				{scripts ?? ""}
			...
			<body class="page">
				<nav class="nav">
					{title ?? <span class="nav-title">{site.title}</span>}
				...
				<footer class="footer">
					<ul class="footer-list">
						...
						<li class="footer-item">&copy; {site.author}</li>
					</ul>
				</footer>
			</body>
		</html>
